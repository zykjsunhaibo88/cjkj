...
public class DateUtil {
    static final Logger _LOG = LoggerFactory.getLogger(DateUtil.class);
    /**
     * 获取SimpleDateFormat
     * @param parttern 日期格式
    ...
    public static Date StringToDate(String date) {
        //DateStyle dateStyle = "yyyy-MM-dd";
...
/*    public static String addDay(String date, int dayAmount) {
    ...
    public static String getPreYearMonth(Date date) {
        Date temp =  addMonth(date, -1);
        return DateToString(temp, DateStyle.YYYY_MM);
    }
